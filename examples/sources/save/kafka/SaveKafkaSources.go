...
func main() {
	body := davudpasha.SourcesSaveRequest{
		Lgs: &davudpasha.SourcesItem{
			...
			Name:             common.PtrString("test-kafka-source"),
			LogSourceDefCode: common.PtrString("test-kafka-lgs-defcode"),
			LogReaderType:    davudpasha.LOGREADERTYPE_KAFKA,
			AlertTimeout:     common.PtrInt64(120),
			LogReaderData: &davudpasha.SourcesLogReaderData{
				Partition:  common.PtrInt64(0),
				Credential: common.PtrString("MYWFIRVM"),
				Topic:      common.PtrString("test-topic"),
			},
