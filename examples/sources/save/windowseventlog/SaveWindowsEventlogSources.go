...
func main() {
	...
	saveSourcesBody := davudpasha.SourcesSaveRequest{
		Lgs: &davudpasha.SourcesItem{
			...
			Name:             common.PtrString("test-we-source"),
			LogSourceDefCode: common.PtrString("test-we-lgs-defcode"),
			LogReaderType:    davudpasha.LOGREADERTYPE_EVENTLOG,
			...
			LogReaderData: &davudpasha.SourcesLogReaderData{
				...
				Source: common.PtrString("Application"),
			},
