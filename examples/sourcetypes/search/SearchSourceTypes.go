...
func main() {
	...
	resp, r, err := api.SearchSourceTypes(ctx, *davudpasha.NewSearchSourceTypesOptionalParameters().WithBody(body))
	...
	fmt.Fprintf(os.Stdout, "Response from `SourceTypesApi.SearchSourceTypes`:\n%s\n", responseContent)
